public class BankAccount {
    ...
    public void displayAccountInfo() {
        System.out.println("Account Number: " + accountNumber + ", Holder: " + accountHolder + ", Balance: " + balance + ", Interest Earned: " + calculateInterest());
    }
    public static void main(String[] args) {
        BankAccount.setBankName("Global Bank");
        BankAccount.setInterestRate(5.0);
        BankAccount acc1 = new BankAccount("A101", "Manohar", 1000);
        BankAccount acc2 = new BankAccount("A102", "Reddy", 2000);
        ...
        System.out.println("Total Accounts (via static): " + BankAccount.getTotalAccounts());
